...
<div id="singletitle-div">
  <span class="singlecat-outer">
  <?
    $categories = get_the_category();
    if($categories){
    foreach($categories as $category)
    {
      echo 'Posted in: <a class="singlecat '.(str_replace(" ", "-", $category->cat_name)).'"" href="'.get_category_link( $category->term_id ).'" title="' . esc_attr( sprintf( __( "View all posts in %s" ), $category->name ) ) . '">'.$category->cat_name.'</a>';
      break;
    }
    }
  ?>
  ...
  <span class="singleauthor singledate">
